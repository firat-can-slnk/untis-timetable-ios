...
open class JZWeekViewFlowLayout: UICollectionViewFlowLayout {
    ...
    open var hourHeightTimes: CGFloat { return hourHeight * 24 }
    open var maxSectionHeight: CGFloat { return columnHeaderHeight + hourHeightTimes + contentsMargin.top + contentsMargin.bottom + allDayHeaderHeight }
